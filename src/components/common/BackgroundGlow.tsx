    ...
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-[-1]">
      ...
      {!isMobile ? (
        ...
        <>
          ...
          <div className="absolute bottom-[10%] right-[5%] w-96 h-96 bg-indigo-500/5 rounded-full blur-[120px]" />
        </>
      )}

      {/* Floating Parallax SVGs - hidden completely from DOM on mobile */}
      {!isMobile && (
        <>
          <motion.div style={{ y: y1 }} className="absolute top-[20%] right-[15%] opacity-20">
          ...
          <motion.div style={{ y: y2 }} className="absolute top-[60%] left-[10%] opacity-20">
          ...
          <motion.div style={{ y: y3 }} className="absolute bottom-[20%] right-[25%] opacity-10 text-primary">
