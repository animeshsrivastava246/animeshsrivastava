...
const Footer = () => {
  ...
  return (
    <motion.footer
      ...
      className="w-full text-foreground py-2 flex flex-col items-center text-sm px-4 border-t border-border/50"
    >
      <div className="flex items-center flex-wrap justify-center gap-3 text-muted-foreground w-full max-w-4xl">
        <span>Built with</span>
        <FaHeart className="text-red-500 animate-pulse hover:scale-125 duration-200 transition-transform" />
        <span>using</span>
      ...
      <div className="mt-2 text-muted-foreground text-center font-heading text-xs tracking-wider uppercase flex flex-col items-center gap-1">
